...
class BikeImageUploadScreen extends StatefulWidget {
  @override
  _CarImageUploadScreenState createState() => _CarImageUploadScreenState();
}

class _CarImageUploadScreenState extends State<BikeImageUploadScreen> {
  ...
  Future<void> _saveCarData() async {
    try {
      ...
      await FirebaseFirestore.instance.collection('bike').add({
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: _images[i] == null
                      ...
                      : Image.file(_images[i]!, fit: BoxFit.fill,),
                ),
              ),
            SizedBox(height: 20),
